...
- MSI `ProductVersion` is derived from the first three parts of the public version. For v0.1.0.4, the MSI product version is `0.1.0`, while filenames, tags, and app metadata remain `0.1.0.4`.
